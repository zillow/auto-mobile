      ...
      Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
          ...
          OutlinedTextField(
            ...
            onValueChange = {
              emailText = it
              validationErrorText = if (it.isNotEmpty() && !it.contains("@")) {
            ...
            supportingText = if (validationErrorText.isNotEmpty()) {
    ...
    item {
      Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
          ...
          SelectionContainer {
            Text(
              text = "This text can be selected and copied. Long press to start text selection and drag to select the desired text portion.",
              modifier = Modifier.fillMaxWidth()
            )
          }
        }
