...
object OnboardingDestination :
    AppDestination(route = "onboarding", deepLinkPattern = "automobile://playground/onboarding")

object LoginDestination :
    AppDestination(route = "login", deepLinkPattern = "automobile://playground/login")

object HomeDestination :
    AppDestination(route = "home", deepLinkPattern = "automobile://playground/home")

object SlidesDestination :
    AppDestination(
