 ...
 */
fun getIntroductionSlides(): List<SlideContent> = listOf(
  SlideContent.LargeText(
    title = "AutoMobile",
    subtitle = "Jason Pearson @ Zillow"
  ),
  ...
  SlideContent.LargeText(
    title = "AutoMobile is a set of tools for automating the authoring and execution of UI testing"
  ),
  ...
  SlideContent.BulletPoints(
    points = listOf(
      BulletPoint(
        text = "Directly uses Android platform tools"
      ),
      BulletPoint(
        text = "Runs as a simple JVM test"
      ),
      BulletPoint(
        text = "Understands your source code"
      ),
    )
  ),
  ...
  SlideContent.BulletPoints(
    ...
    points = listOf(
      ...
      // TODO: Uncomment if koog lands BulletPoint("An agentic loop for intelligently self-healing tests")
    )
  ),
)
