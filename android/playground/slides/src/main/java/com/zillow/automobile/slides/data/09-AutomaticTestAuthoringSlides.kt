...
fun getAutomaticTestAuthoringSlides(): List<SlideContent> = listOf(
  SlideContent.LargeText(
    title = "Automatic Test Authoring"
  ),
  ...
  SlideContent.BulletPoints(
    ...
    points = listOf(
      BulletPoint(
        text = "Writes Kotlin test files with KotlinPoet + public modifier scrubbing"
      ),
      BulletPoint(
        text = "Highly configurable to put tests in the right place"
      ),
    )
  ),
  ...
  SlideContent.BulletPoints(
    ...
    points = listOf(
      BulletPoint(
        text = "Root common module of plurality of Composable (default)"
      ),
      BulletPoint(
        text = "Submodule of root common with greatest plurality"
      ),
      BulletPoint(
        text = "Activity/Fragment only"
      ),
      BulletPoint(
  ...
  SlideContent.Emoji(
    ...
    caption = "Allows for parallelization and distribution of UI testing decoupling from custom tooling"
  ),
)
