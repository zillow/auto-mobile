 ...
 */
fun getOriginSlides(): List<SlideContent> = listOf(
// - Origin Story
//    - Was looking into open source MCP servers because I knew from early experiences that they could be powerful
//    - Didn't find what I was looking for
//      - Most MCP tool calls were wrapper implementations of existing tools
//      - Diagram of screenshot, tap, screenshot, swipe with AI agent. That's like throwing instructions at someone who has never used a mobile phone before
//      - What if instead I looked at it from the perspective of someone who knows how to navigate mobile devices? After all we'd all love to have a UI testing tool that could innately understand that.
//      - Big text slides
//        - Open recent apps
...
//        - Mermaid diagram showing system design of automatic observation on interaction
  ...
  SlideContent.Emoji(
    emoji = PresentationEmoji.DOLPHIN,
    caption = "Flipper got deprecated in 2024"
  ),
  ...
  // - Mermaid Diagram of screenshot, tap, screenshot, swipe with AI agent. That's like throwing instructions at someone who has never used a mobile phone before
  ...
  SlideContent.Emoji(
    ...
    caption = "What if instead I looked at it from the perspective of someone who knows how to navigate mobile devices?"
  ),

  SlideContent.LargeText(
    title = "Depending on device settings either swipe up from bottom edge or tap the recent apps button",
  ...
  SlideContent.LargeText(
    title = "Double tap on text, tap \"Select All\", tap \"Cut\" or press Delete key to clear text field",
