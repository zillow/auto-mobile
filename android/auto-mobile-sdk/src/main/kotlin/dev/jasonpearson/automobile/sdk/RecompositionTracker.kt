...
object RecompositionTracker {
    ...
    fun recordRecomposition(
        ...
        entry.record(composableName, resourceId, testTag, parentChain, stableAnnotated, rememberedCount, likelyCause)
    }
    ...
    private fun broadcastSnapshot() {
        ...
        val intent = Intent(AutoMobileSDK.ACTION_RECOMPOSITION_SNAPSHOT).apply {
    ...
    private fun registerControlReceiver(context: Context) {
        val filter = IntentFilter().apply {
            addAction(AutoMobileSDK.ACTION_RECOMPOSITION_CONTROL)
        }
