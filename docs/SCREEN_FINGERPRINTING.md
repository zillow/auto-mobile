# Screen Fingerprinting Strategy

## Overview

Screen fingerprinting is the process of generating a stable identifier for UI screens that remains consistent despite dynamic content changes, scrolling, keyboard appearance, and user interactions.

This document describes AutoMobile's research-backed fingerprinting strategy that achieves high accuracy across diverse scenarios.
...
- Research findings:
  ...
  - `scratch/FINDINGS.md` - Initial research
