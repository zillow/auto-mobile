...
2. Draw [visual highlights](../design-docs/mcp/visual-highight.md) around defects or important elements.
2. Take a snapshot of device state using the [deviceSnapshot](../design-docs/mcp/snapshots.md).
