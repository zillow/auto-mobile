...
export const IOS_CTRL_PROXY_SHA256_CHECKSUM: string = "1452c0f3f133713049d4446616a9eddb710ea07c164fbd8d14c5a217d2fd1c0c"; // Empty = skip verification (local dev only)
