...
export const XCTESTSERVICE_SHA256_CHECKSUM: string = "8240511e6239e3d6c2db86915863867c99e236f0028b0ef54ae7c016a9d7c3d4"; // Empty = skip verification (local dev only)
