...
export const XCTESTSERVICE_SHA256_CHECKSUM: string = "ffbb85298b50a95a1498ce716ecc4262b56b6d31471747c08ec95d13b102569d"; // Empty = skip verification (local dev only)
