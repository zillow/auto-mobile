...
export const XCTESTSERVICE_SHA256_CHECKSUM: string = "f713ca499e593e1561b8877364ffa8702f5b4f6c33ee374bffa4c86ab38b4bee"; // Empty = skip verification (local dev only)
