...
export const IOS_CTRL_PROXY_SHA256_CHECKSUM: string = "f72ca0594f7a34a1bfdbd654d727edde9cbe58115555a20f893ae845098aaaa8"; // Empty = skip verification (local dev only)
