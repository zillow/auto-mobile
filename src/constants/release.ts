...
export const XCTESTSERVICE_SHA256_CHECKSUM: string = "b6e5fa9879c58759497b594a71ca44e3a053b1abb71fae32765b8ef30edb5a58"; // Empty = skip verification (local dev only)
