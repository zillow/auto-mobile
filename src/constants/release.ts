...
export const XCTESTSERVICE_SHA256_CHECKSUM: string = "17edbeb10a0407dc123a0bfecf9edec38e19c901ae57c8bdb0dbf1990e86368a"; // Empty = skip verification (local dev only)
