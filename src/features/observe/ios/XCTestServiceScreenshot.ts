/**
 * XCTestServiceScreenshot - Delegate for screenshot operations.
 *
 * This delegate handles screenshot capture via the iOS XCTestService WebSocket API.
 */
 ...
 */
export class XCTestServiceScreenshot {
  ...
  /**
   * Request a screenshot from the XCTestService.
   */
