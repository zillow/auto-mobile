/**
 * XCTestServiceHierarchy - Delegate for hierarchy operations.
 *
 ...
 */
export class XCTestServiceHierarchy {
  ...
  async requestHierarchySync(
    ...
    const promise = this.context.requestManager.register<{ hierarchy?: XCTestHierarchy; perfTiming?: XCTestPerfTiming }>(
      requestId,
      "hierarchy",
      timeoutMs,
