...
call_mcp_tool "tapOn" --action "tap" --selector '{"id": "com.android.camera2:id/mode_options_toggle"}' --platform "android"
...
call_mcp_tool "tapOn" --action "tap" --selector '{"id": "com.android.camera2:id/shutter_button"}' --platform "android"
...
call_mcp_tool "tapOn" --action "tap" --selector '{"id": "com.android.camera2:id/rounded_thumbnail_view"}' --platform "android"
...
call_mcp_tool "tapOn" --action "tap" --selector '{"id": "com.android.camera2:id/filmstrip_bottom_control_edit"}' --platform "android"
...
call_mcp_tool "tapOn" --action "tap" --selector '{"id": "android:id/button_once"}' --platform "android"
...
call_mcp_tool "tapOn" --action "tap" --selector '{"text": "Top boundary 0 percent"}' --platform "android"
...
call_mcp_tool "tapOn" --action "tap" --selector '{"id": "com.google.android.markup:id/save"}' --platform "android"
...
call_mcp_tool "tapOn" --action "tap" --selector '{"id": "com.android.camera2:id/filmstrip_bottom_control_share"}' --platform "android"
