...
call_mcp_tool "tapOn" --action "tap" --selector '{"id": "com.android.chrome:id/tab_switcher_button"}' --platform "android"
...
call_mcp_tool "tapOn" --action "tap" --selector '{"id": "com.android.chrome:id/menu_button"}' --platform "android"
...
call_mcp_tool "tapOn" --action "tap" --selector '{"id": "com.android.chrome:id/close_all_tabs_menu_id"}' --platform "android"
...
call_mcp_tool "tapOn" --action "tap" --selector '{"id": "com.android.chrome:id/positive_button"}' --platform "android"
...
call_mcp_tool "tapOn" --action "tap" --selector '{"id": "com.android.chrome:id/new_tab_view"}' --platform "android"
...
echo ""
add_line "●${GRAY} Navigating to m.youtube.com…${RESET}"
echo ""
add_line "${BOLD}● auto-mobile - tapOn (MCP)${RESET}${GRAY} (action: \"tap\", id: \"com.android.chrome:id/search_box_text\")${RESET}"
call_mcp_tool "tapOn" --action "tap" --selector '{"id": "com.android.chrome:id/search_box_text"}' --platform "android"
...
echo ""
add_line "${BOLD}● auto-mobile - inputText (MCP)${RESET}${GRAY} (text: \"m.youtube.com\", imeAction: \"go\")${RESET}"
call_mcp_tool "inputText" --text "m.youtube.com" --imeAction "go" --platform "android"
...
call_mcp_tool "tapOn" --action "tap" --selector '{"text": "Search YouTube"}' --platform "android"
...
call_mcp_tool "tapOn" --action "tap" --selector '{"text": "AutoMobile - Jason Pearson | droidcon New York 2025"}' --platform "android"
...
call_mcp_tool "tapOn" --action "tap" --selector '{"text": "Skip"}' --platform "android"
replace_prev_line "${GREEN}●${RESET}${BOLD} auto-mobile - tapOn (MCP)${RESET}${GRAY} (action: \"tap\", text: \"AutoMobile - Jason Pearson...\")${RESET}"
