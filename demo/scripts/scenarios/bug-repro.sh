...
call_mcp_tool "tapOn" --action "tap" --selector '{"id": "bug_repro_add"}' --platform "android"
...
call_mcp_tool "tapOn" --action "tap" --selector '{"id": "bug_repro_toggle"}' --platform "android"
...
call_mcp_tool "highlight" --action "tap" --selector '{"text": "Displayed count"}' --platform "android"
...
call_mcp_tool "tapOn" --action "tap" --selector '{"id": "bug_repro_reset"}' --platform "android"
